    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background: linear-gradient(45deg, rgba(38,160,231,1) 23%, rgba(32,115,176,1) 65%, rgba(29,89,145,1) 89%, rgba(27,77,131,1) 100%);color: #ffffff;">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0" >
                    <li class="nav-item active">
                        <a class="nav-link" href="cam1.php">Canon 1100D<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="cam2.php">Canon 70D</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="cam3.php">Canon 760D</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="cam4.php">Canon 650D</a>
                    </li>
            ...
            <div class="container mt-4">
                ...
                <?php
                        require_once'dbconfig.php';
                        $sql = "SELECT * FROM device WHERE device_name='Canon 1100D'";
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-6 col-lg-6 text-center">
                                    <img style='width:100%; height: auto;' src='pic/1.png'>
