        ...
        <div class="row col-12 mt-5" align ="center" >
            <div class="col-md">
                <div class="card" style="width: 25rem;">
                    <a href="leg1.php"><img class="zoom" style="width: 60%; height: auto;" src="pic/E_MANFROTTOรุ่น190XPROB_496RC2.png" alt="Card image cap"></a>
                    <div class="card-body">
                        <h5 class="card-title">MANFROTTO</h5>
                        <p class="card-text">จำนวน : 12 ชุด<br><br>
                        <div align='left'>รุ่น 190 XPROB/496RC2</div> </p>
                        <a href="leg1.php" class="btn btn-primary">จอง</a>
                    </div>
                </div>
            </div>
            <div class="col-md">
                <div class="card" style="width: 25rem;">
                    <a href="leg2.php"><img class="zoom" style="width: 60%; height: auto;" src="pic/F_MANFROTTOรุ่น701HDVMVT502AM.png" alt="Card image cap"></a>
                    <div class="card-body">
                        <h5 class="card-title">MANFROTTO</h5>
                        <p class="card-text">จำนวน : 5 ชุด<br><br>
                        <div align='left'>รุ่น 701HDV MVT502AM</div> </p>
                        <a href="leg2.php" class="btn btn-primary">จอง</a>
                    </div>
                </div>
            </div>
            <div class="col-md">
                <div class="card" style="width: 25rem;">
                    <a href="leg3.php"><img class="zoom" style="width: 60%; height: auto;" src="pic/G_MANFROTTOรุ่น127VS.png" alt="Card image cap"></a>
                    <div class="card-body">
                        <h5 class="card-title">MANFROTTO</h5>
                        <p class="card-text">จำนวน : 2 ชุด<br><br>
                        <div align='left'>รุ่น 127VS</div> </p>
                        <a href="leg3.php" class="btn btn-primary">จอง</a>
                    </div>
                </div>
            </div>
        </div>
