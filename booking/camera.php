            ...
            <div class="row">
                <div class="col-4 mb-5">
                    <div class="card" style="width: 25rem;">
                        <a href="cam1.php"><img class="zoom" style="width: 60%; height: auto;" src="pic/1.png" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title">CANNON 1100D</h5>
                            <p class="card-text">              
                            จำนวน : 10 ชุด
                                <div align='left'>
                                    อุปกร์เสริม : <br>
                                    -	เลนส์ EFS 18-55 mm.<br>
                                    -	kingston SD 32GB.<br>
                                    -	ฟิตเตอร์ cannon 58 mm.<br>
                                    -	Cannon battary charger LC-E10E<br>
                                    -	Cannon battery LP-E10<br>
                                    -	สายคล้องกล้อง<br>
                                    -	กระเป๋าใส่กล้อง Lowepro<br>
                                    -	สาย USB<br>
                                </div>
                            </p>
                        </div>
                            <a href="cam1.php" class="btn btn-primary">&emsp;&emsp;จอง&emsp;&emsp;</a>
                    </div>
                </div>
                ...
                <div class="col-4 mb-5">
                    <div class="card" style="width: 25rem;">
                        ...
                        <a href="cam4.php"><img class="zoom" style="width: 60%; height: auto;" src="pic/2.png" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title">CANNON 650D</h5>
                            <p class="card-text">
                                จำนวน : 30 ชุด
                                 <div align='left'>
                                     อุปกร์เสริม :<br>
                                -	เลนส์ EFS 18-135 mm.<br>
                                -	kingston SD 16GB.<br>
                                -	ฟิตเตอร์ cannon 67 mm.<br>
                                -	Cannon battary charger LC-E8E<br>
                                -	Cannon battery LP-E8<br>
                                -	สายคล้องกล้อง<br>
                                -	กระเป๋าใส่กล้อง Together<br><br>
                                </div>

                            </p>
                        </div>
                            <a href="cam4.php" class="btn btn-primary">&emsp;&emsp;จอง&emsp;&emsp;</a>
                    </div>
                </div>
              
                <div class="col-4 mb-5">
                    <div class="card" style="width: 25rem;">
                        <a href="cam2.php"><img class="zoom" style="width: 60%; height: auto;" src="pic/3.png" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title">CANNON 70D</h5>
                            <p class="card-text">
                                จำนวน : 20 ชุด
                            <div align='left'>
                                อุปกร์เสริม : <br>
                            ...
                            <a href="cam2.php" class="btn btn-primary">&emsp;&emsp;จอง&emsp;&emsp;</a>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="card" style="width: 25rem;">
                        <a href="cam3.php"><img class="zoom" style="width: 60%; height: auto;" src="pic/4.png" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title">CANNON 760D</h5>
                            <p class="card-text">
                                จำนวน : 20 ชุด
                            <div align='left'>
                                อุปกร์เสริม : <br>
                            ...
                            <a href="cam3.php" class="btn btn-primary">&emsp;&emsp;จอง&emsp;&emsp;</a>
                    </div>
                </div>
             </div>
        </div>
