...
<html>
    ...
    <body> <font size='3.5'>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0" >
                    <li class="nav-item active">
                        <a class="nav-link" href="flash1.php">580EX 2<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="flash2.php">320EX</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="flash3.php">430EX ll</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="flash4.php">320EX ll</a>
                    </li>
       ...
       <div class="container mt-4">
                ...
                <?php
                        require_once'dbconfig.php';
                        $sql = "SELECT * FROM device WHERE device_name='cannon speedlight 580EX 2'";
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-6 col-lg-6 text-center">
                                    <img style='width:100%; height: auto;' src='pic/H_canonspeelight 580ex 2.png'>
